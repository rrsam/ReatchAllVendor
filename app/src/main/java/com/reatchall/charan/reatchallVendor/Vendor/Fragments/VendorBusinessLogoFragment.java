 ...
 */
public class VendorBusinessLogoFragment extends Fragment {

    private static final String TAG = "VendorBusinessLogoFragm";
    View view;
    ...
    public VendorBusinessLogoFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_vendor_business_logo, container, false);
        return  view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        vendorBusinessSettingsNewActivity.highlightTab(0);
                ...
                try {
                    if(response.getBoolean("success")){
                        ...
                        if(basicDetails.has("temp_logo")){
                            ...
                            Glide.with(context).load(new URL(basicDetails.getJSONObject("temp_logo").getString("url"))).into(imageIV);
                        }
                    }else{
    ...
    private void postListnew(String imgUrl,String key){
        String url=Constants.BASE_URL+"vendor_mobile/upload-business-logo-mobile";
