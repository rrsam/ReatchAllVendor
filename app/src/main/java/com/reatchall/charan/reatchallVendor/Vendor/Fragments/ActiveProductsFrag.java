...
public class ActiveProductsFrag extends Fragment implements ILoadProducts, VendorAllProductsAdapter.OnItemClickListener {
    ...
    public ActiveProductsFrag() {
        // Required empty public constructor
    }


    public static ActiveProductsFrag newInstance(BusinessDetails businessDetails) {
        ActiveProductsFrag fragment = new ActiveProductsFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.frag_active_products, container, false);

        rvProducts = view.findViewById(R.id.rv_active_prod);
