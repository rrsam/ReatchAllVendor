 ...
 */
public class VendorEditEmailFragment extends Fragment {

    private static final String TAG = "VendorEditEmailFragment";
    View view;
    ...
    public VendorEditEmailFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_vendor_edit_email, container, false);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        vendorEditProfileActivity.highlightTab(3);
        ...
        userName.setText(vendorDetails.getEmail());
            ...
            public void onClick(View view) {
                if(editProfile.getText().toString().equalsIgnoreCase("SAVE")){
                    if(!userName.getText().toString().isEmpty()){
                        if(EmailValidator(userName.getText().toString())){
                            if(userName.getText().toString().equals(vendorDetails.getEmail())){
    ...
    private void update(){
        String url = Constants.BASE_URL+"vendor/update-vendor-email";

        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("vendor_id",prefManager.getVendorId(context));
            jsonObject.put("new_email",userName.getText().toString());
            jsonObject.put("otp",otp.getText().toString());
            jsonObject.put("email",vendorDetails.getPhoneNumber());
