...
public class ManageProductsFrag extends Fragment implements BusinessAllProductsAdapter.OnItemClickListener, BusinessAllProductsAdapter.OncheckChangeListener, ILoadProducts {
    ...
    private BusinessAllProductsAdapter businessAllProductsAdapter;


    public ManageProductsFrag() {
    }

    public static ManageProductsFrag newInstance(BusinessDetails businessDetails) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvProducts = view.findViewById(R.id.rv_manage_prod);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (success) {
                        ...
                        businessAllProductsAdapter=new BusinessAllProductsAdapter(getActivity(),productsArrayList,ManageProductsFrag.this,
                                (VendorAllProductsActivity) getActivity(),(VendorAllProductsActivity) getActivity());
                        rvProducts.setAdapter(businessAllProductsAdapter);
