...
import com.reatchall.charan.reatchallVendor.Adapters.RatingReviewsAdapter;
...
public class RatingsReviewsActivity extends AppCompatActivity {
    private static final String TAG = "RatingsReviewsActivity";

    RecyclerView recyclerView;
    ArrayList<String> arrayList;
    RatingReviewsAdapter ratingReviewsAdapter;
    ...
    ImageView drawer;
    private Context context = RatingsReviewsActivity.this;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(RatingsReviewsActivity.this, LinearLayoutManager.VERTICAL, false));
        ratingReviewsAdapter=new RatingReviewsAdapter(arrayList,getApplicationContext());
        recyclerView.setAdapter(ratingReviewsAdapter);
