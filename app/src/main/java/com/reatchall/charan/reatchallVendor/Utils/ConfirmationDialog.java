...
public class ConfirmationDialog extends Dialog {
    ...
    public ConfirmationDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected ConfirmationDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
