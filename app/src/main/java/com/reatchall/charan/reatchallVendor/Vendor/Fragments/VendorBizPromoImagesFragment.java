 ...
 */
public class VendorBizPromoImagesFragment extends Fragment {

    private static final String TAG = "VendorBizPromoImagesFra";
    View view;
    ...
    private void getImages(){
        String url = Constants.BASE_URL+"vendor/get-promotional-images/"+businessDashboard.getBusinessId();
    ...
    private void formString(){
        ...
        try {
            ...
            postItemJson.put("image",itemImagesJsonArray);
    ...
    private void addItemToBusiness(JSONObject jsonObject){
        String url=Constants.BASE_URL+"vendor_mobile/add-promotional-images-mobile";
    ...
    VendorBizPromoImagesAdapter vendorBizBannersAdapter;
    @Override
