...
public class MultiSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        ArrayAdapter<String> adapterSpinner = new ArrayAdapter<>(getContext(), R.layout.multi_spinner_textview_item, new String[]{spinnerText});
    ...
    public void setItems(List<KeyPairBoolData> items, int position, SpinnerListener listener) {
        ...
        ArrayAdapter<String> adapterSpinner = new ArrayAdapter<>(getContext(), R.layout.multi_spinner_textview_item, new String[]{defaultText});
        setAdapter(adapterSpinner);
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final int backgroundColor = (position%2 == 0) ? R.color.background_color : R.color.background_color;
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    Log.i(TAG, "On Click Selected OrderedItem : " + data.getName() + " : " + data.isSelected());
                    notifyDataSetChanged();
                }
            });
            if (data.isSelected()) {
                holder.textView.setTypeface(null, Typeface.BOLD);
                convertView.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.background_color));
            }
