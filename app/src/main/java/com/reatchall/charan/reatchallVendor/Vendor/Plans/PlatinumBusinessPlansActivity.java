...
public class PlatinumBusinessPlansActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_platinum_business_details);
        ...
        comparePackages.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(PlatinumBusinessPlansActivity.this, ComparePlansActivity.class);
