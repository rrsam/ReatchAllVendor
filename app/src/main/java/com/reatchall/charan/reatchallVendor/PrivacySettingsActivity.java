...
public class PrivacySettingsActivity extends AppCompatActivity {
    ...
    ImageView drawer;
    private Context context = PrivacySettingsActivity.this;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        changePassword=(FontTextView)findViewById(R.id.changePassword);
        changePassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PrivacySettingsActivity.this, ChangePasswordActivity.class));
