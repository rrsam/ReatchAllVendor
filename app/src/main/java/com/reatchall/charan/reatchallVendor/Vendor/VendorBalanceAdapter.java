...
public class VendorBalanceAdapter extends RecyclerView.Adapter<VendorBalanceAdapter.VendorBalanceViewHolder> {

    ArrayList<String> arrayList;
    private Context context;


    public VendorBalanceAdapter(ArrayList<String> arrayList, Context context) {
