...
public class SilverBusinessPlansActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_silver_business_plans);
        ...
        comparePackages.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SilverBusinessPlansActivity.this, ComparePlansActivity.class);
